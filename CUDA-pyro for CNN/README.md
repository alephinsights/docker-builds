...
2. **Run**: 	`docker --runtime=nvidia run -u 1000:1000 -it -p 8888:8888 -p 6006:6006 -v /<HOST DIR YOU WANT TO USE ON GUEST>:/project petecog/cuda-pyro:gpu bash`
...
docker build -t petecog/cuda-pyro:gpu -f Dockerfile.gpu .
```
